...
const S = {
  ...
  header: { padding: "26px 20px 0", maxWidth: 1180, margin: "0 auto" },
  ...
  strip: { maxWidth: 1180, margin: "22px auto 0", padding: "0 20px", display: "flex", alignItems: "center", gap: 12 },
  stripScroll: { display: "flex", gap: 10, overflowX: "auto", paddingBottom: 6, flex: 1 },
  ...
  main: { maxWidth: 1180, margin: "26px auto 0", padding: "0 20px" },
  ...
  mc: { minHeight: "100vh", boxSizing: "border-box", padding: "24px 18px 40px", display: "flex", flexDirection: "column", gap: 18 },
  ...
  tabBarWrap: { display: "flex", justifyContent: "center", alignItems: "center", gap: 12, paddingTop: 18, position: "relative" },
  tabBar: { display: "inline-flex", gap: 4, background: "rgba(255,255,255,.04)", border: "1px solid rgba(255,255,255,.08)", borderRadius: 16, padding: 5 },
  ...
  signOut: { position: "absolute", right: 20, border: "1px solid rgba(255,255,255,.12)", background: "rgba(255,255,255,.04)", color: "#94A3B8", fontWeight: 700, fontSize: 13, padding: "8px 14px", borderRadius: 12, cursor: "pointer", fontFamily: FONT },

  schedule: { maxWidth: 1180, margin: "20px auto 0", padding: "0 20px 60px" },
